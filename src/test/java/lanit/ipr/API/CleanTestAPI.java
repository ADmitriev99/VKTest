...
public class CleanTestAPI extends PropertiesTest {
    public static void CleanStepAPI(){
        ...
        request.post(properties.getProperty("baseURI")+ "messages.deleteConversation?peer_id=-" + properties.getProperty("groupId") + "&"+ properties.getProperty("access_token")+properties.getProperty("V"));
